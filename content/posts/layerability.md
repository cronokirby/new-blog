...
TCP sockets can be closed without warning, and HTTP requests can sometimes fail.
...
a few languages with a similar stack underneath them, such as Chicken Scheme.
...
of vectorization operations, we need to go down to assembly. Of course, we could use a library making use of these primitives, and
compilers are getting better at including these intrinsics.
